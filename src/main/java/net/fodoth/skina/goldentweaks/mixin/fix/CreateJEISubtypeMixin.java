...
public class CreateJEISubtypeMixin {
    ...
    private <B, I> void goldentweaks$ignoreDuplicateSubtypeRegistration(
        ...
        try {
            ...
            if (ingredientBase instanceof Fluid fluid) {
                GoldenTweaks.LOGGER.warn(
                        "Ignored duplicate JEI subtype interpreter registration for fluid: {}",
                        fluid
                );
            } else {
                GoldenTweaks.LOGGER.warn(
                        "Ignored duplicate JEI subtype interpreter registration for ingredient: {}",
                        ingredientBase
                );
            }
        }
